...
#docker run --name php72.teste --network=intranet -l traefik.enable=false -v $PWD/html:/var/www/html -d php:7.2-fpm-stretch
#docker exec -it php72.$1 docker-php-ext-install mysqli

#apt-get update && apt-get install -y zlib1g-dev libc-client-dev libkrb5-dev && rm -r /var/lib/apt/lists/*
#docker-php-ext-install zip
#docker-php-ext-configure imap --with-kerberos --with-imap-ssl
#docker-php-ext-install imap

#docker exec -it php72.teste sh -c 'apt-get update && apt-get install -y zlib1g-dev libc-client-dev libkrb5-dev && rm -r /var/lib/apt/lists/*'
#docker exec -it php72.teste sh -c 'docker-php-ext-configure imap --with-kerberos --with-imap-ssl && docker-php-ext-install imap zip mysqli'
